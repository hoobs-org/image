...
compilation_prepare()
{
	...
	elif linux-version compare "${version}" ge 5.8.17 && linux-version compare "${version}" le 5.9 || linux-version compare "${version}" ge 5.9.2; then
	...
	if [[ "${version}" == "4.4."* ]] && [[ "$LINUXFAMILY" == rockchip64 || "$LINUXFAMILY" == station* ]]; then
		display_alert "Adjusting" "packaging" "info"
	...
	if linux-version compare "${version}" ge 5.4 && linux-version compare "${version}" le 5.12 && [ $LINUXFAMILY != mvebu64 ] && [ $LINUXFAMILY != rk322x ] && [ $LINUXFAMILY != odroidxu4 ] && [ $EXTRAWIFI == yes ]; then
		...
		cp -R "${SRC}/cache/sources/rtl8152/${rtl8152ver#*:}"/{r8152.c,compatibility.h} "$kerneldir/drivers/net/usb/"
	fi
	...
	if linux-version compare "${version}" ge 3.14 && [ "$EXTRAWIFI" == yes ]; then
		...
		cp -R "${SRC}/cache/sources/rtl8189es/${rtl8189esver#*:}"/{core,hal,include,os_dep,platform} "$kerneldir/drivers/net/wireless/rtl8189es"
		cp "${SRC}/cache/sources/rtl8189es/${rtl8189esver#*:}/Makefile" "$kerneldir/drivers/net/wireless/rtl8189es/Makefile"

		sed -i 's/---help---/help/g' "${SRC}/cache/sources/rtl8189es/${rtl8189esver#*:}/Kconfig"

		cp "${SRC}/cache/sources/rtl8189es/${rtl8189esver#*:}/Kconfig" "$kerneldir/drivers/net/wireless/rtl8189es/Kconfig"

		echo "obj-\$(CONFIG_RTL8189ES) += rtl8189es/" >> "$kerneldir/drivers/net/wireless/Makefile"
		sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/rtl8189es\/Kconfig"' "$kerneldir/drivers/net/wireless/Kconfig"
	fi
	...
	if linux-version compare "${version}" ge 3.14 && [ "$EXTRAWIFI" == yes ]; then
		...
		cp -R "${SRC}/cache/sources/rtl8189fs/${rtl8189fsver#*:}"/{core,hal,include,os_dep,platform} "$kerneldir/drivers/net/wireless/rtl8189fs"
		cp "${SRC}/cache/sources/rtl8189fs/${rtl8189fsver#*:}/Makefile" "$kerneldir/drivers/net/wireless/rtl8189fs/Makefile"

		sed -i 's/---help---/help/g' "${SRC}/cache/sources/rtl8189fs/${rtl8189fsver#*:}/Kconfig"
		cp "${SRC}/cache/sources/rtl8189fs/${rtl8189fsver#*:}/Kconfig" "$kerneldir/drivers/net/wireless/rtl8189fs/Kconfig"

		echo "obj-\$(CONFIG_RTL8189FS) += rtl8189fs/" >> "$kerneldir/drivers/net/wireless/Makefile"
		sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/rtl8189fs\/Kconfig"' "$kerneldir/drivers/net/wireless/Kconfig"
	fi
	...
	if linux-version compare "${version}" ge 3.14 && [ "$EXTRAWIFI" == yes ]; then
		...
		cp -R "${SRC}/cache/sources/rtl8192eu/${rtl8192euver#*:}"/{core,hal,include,os_dep,platform} "$kerneldir/drivers/net/wireless/rtl8192eu"
		cp "${SRC}/cache/sources/rtl8192eu/${rtl8192euver#*:}/Makefile" "$kerneldir/drivers/net/wireless/rtl8192eu/Makefile"

		sed -i 's/---help---/help/g' "${SRC}/cache/sources/rtl8192eu/${rtl8192euver#*:}/Kconfig"
		cp "${SRC}/cache/sources/rtl8192eu/${rtl8192euver#*:}/Kconfig" "$kerneldir/drivers/net/wireless/rtl8192eu/Kconfig"

		echo "obj-\$(CONFIG_RTL8192EU) += rtl8192eu/" >> "$kerneldir/drivers/net/wireless/Makefile"
		sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/rtl8192eu\/Kconfig"' "$kerneldir/drivers/net/wireless/Kconfig"
	fi
	...
	if linux-version compare "${version}" ge 3.14 && [ "$EXTRAWIFI" == yes ]; then
		...
		cp -R "${SRC}/cache/sources/rtl8812au/${rtl8812auver#*:}"/{core,hal,include,os_dep,platform} "$kerneldir/drivers/net/wireless/rtl8812au"
		cp "${SRC}/cache/sources/rtl8812au/${rtl8812auver#*:}/Makefile" "$kerneldir/drivers/net/wireless/rtl8812au/Makefile"
		cp "${SRC}/cache/sources/rtl8812au/${rtl8812auver#*:}/Kconfig" "$kerneldir/drivers/net/wireless/rtl8812au/Kconfig"

		echo "obj-\$(CONFIG_88XXAU) += rtl8812au/" >> "$kerneldir/drivers/net/wireless/Makefile"
		sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/rtl8812au\/Kconfig"' "$kerneldir/drivers/net/wireless/Kconfig"
	fi
	...
	if linux-version compare "${version}" ge 4.19 && [[ "$LINUXFAMILY" == sunxi* ]] && [[ "$EXTRAWIFI" == yes ]]; then
		...
		cp "${SRC}"/cache/sources/xradio/master/*.{h,c} "$kerneldir/drivers/net/wireless/xradio/"
		cp "${SRC}/cache/sources/xradio/master/Makefile" "$kerneldir/drivers/net/wireless/xradio/Makefile"

		sed -i 's/---help---/help/g' "${SRC}/cache/sources/xradio/master/Kconfig"
		cp "${SRC}/cache/sources/xradio/master/Kconfig" "$kerneldir/drivers/net/wireless/xradio/Kconfig"

		echo "obj-\$(CONFIG_WLAN_VENDOR_XRADIO) += xradio/" >> "$kerneldir/drivers/net/wireless/Makefile"
		sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/xradio\/Kconfig"' "$kerneldir/drivers/net/wireless/Kconfig"
	...
	if linux-version compare "${version}" ge 3.14 && [ "$EXTRAWIFI" == yes ]; then
		...
		cp -R "${SRC}/cache/sources/rtl8811cu/${rtl8811cuver#*:}"/{core,hal,include,os_dep,platform,rtl8821c.mk} "$kerneldir/drivers/net/wireless/rtl8811cu"
		cp "${SRC}/cache/sources/rtl8811cu/${rtl8811cuver#*:}/Makefile" "$kerneldir/drivers/net/wireless/rtl8811cu/Makefile"

		sed -i 's/---help---/help/g' "${SRC}/cache/sources/rtl8811cu/${rtl8811cuver#*:}/Kconfig"
		cp "${SRC}/cache/sources/rtl8811cu/${rtl8811cuver#*:}/Kconfig" "$kerneldir/drivers/net/wireless/rtl8811cu/Kconfig"

		sed -i "s/^CONFIG_RTW_DEBUG.*/CONFIG_RTW_DEBUG = n/" "$kerneldir/drivers/net/wireless/rtl8811cu/Makefile"
		sed -i "s/^CONFIG_MP_VHT_HW_TX_MODE.*/CONFIG_MP_VHT_HW_TX_MODE = n/" "$kerneldir/drivers/net/wireless/rtl8811cu/Makefile"

		echo "obj-\$(CONFIG_RTL8821CU) += rtl8811cu/" >> "$kerneldir/drivers/net/wireless/Makefile"
		sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/rtl8811cu\/Kconfig"' "$kerneldir/drivers/net/wireless/Kconfig"
	...
	if linux-version compare "${version}" ge 3.14 && linux-version compare "${version}" lt 5.15 && [ "$EXTRAWIFI" == yes ]; then
		...
		cp -R "${SRC}/cache/sources/rtl8188eu/${rtl8188euver#*:}"/{core,hal,include,os_dep,platform} "$kerneldir/drivers/net/wireless/rtl8188eu"
		cp "${SRC}/cache/sources/rtl8188eu/${rtl8188euver#*:}/Makefile" "$kerneldir/drivers/net/wireless/rtl8188eu/Makefile"

		sed -i 's/---help---/help/g' "${SRC}/cache/sources/rtl8188eu/${rtl8188euver#*:}/Kconfig"
		cp "${SRC}/cache/sources/rtl8188eu/${rtl8188euver#*:}/Kconfig" "$kerneldir/drivers/net/wireless/rtl8188eu/Kconfig"

		sed -i "s/^CONFIG_RTW_DEBUG.*/CONFIG_RTW_DEBUG = n/" "$kerneldir/drivers/net/wireless/rtl8188eu/Makefile"

		echo "obj-\$(CONFIG_RTL8188EU) += rtl8188eu/" >> "$kerneldir/drivers/net/wireless/Makefile"
		sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/rtl8188eu\/Kconfig"' "$kerneldir/drivers/net/wireless/Kconfig"
	...
	if linux-version compare "${version}" ge 5.0 && [ "$EXTRAWIFI" == yes ]; then
		...
		cp -R "${SRC}/cache/sources/rtl88x2bu/${rtl88x2buver#*:}"/{core,hal,include,os_dep,platform,halmac.mk,rtl8822b.mk} "$kerneldir/drivers/net/wireless/rtl88x2bu"
		cp "${SRC}/cache/sources/rtl88x2bu/${rtl88x2buver#*:}/Makefile" "$kerneldir/drivers/net/wireless/rtl88x2bu/Makefile"

		sed -i 's/---help---/help/g' "${SRC}/cache/sources/rtl88x2bu/${rtl88x2buver#*:}/Kconfig"
		cp "${SRC}/cache/sources/rtl88x2bu/${rtl88x2buver#*:}/Kconfig" "$kerneldir/drivers/net/wireless/rtl88x2bu/Kconfig"

		sed -i 's/include $(src)\/rtl8822b.mk /include $(TopDIR)\/drivers\/net\/wireless\/rtl88x2bu\/rtl8822b.mk/' "$kerneldir/drivers/net/wireless/rtl88x2bu/Makefile"

		echo "obj-\$(CONFIG_RTL8822BU) += rtl88x2bu/" >> "$kerneldir/drivers/net/wireless/Makefile"
		sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/rtl88x2bu\/Kconfig"' "$kerneldir/drivers/net/wireless/Kconfig"
	fi
	...
	if linux-version compare "${version}" ge 5.9 && [ "$EXTRAWIFI" == yes ]; then
		...
		cp -R "${SRC}/cache/sources/rtl88x2cs/${rtl88x2csver#*:}"/{core,hal,include,os_dep,platform,halmac.mk,ifcfg-wlan0,rtl8822c.mk,runwpa,wlan0dhcp} "$kerneldir/drivers/net/wireless/rtl88x2cs"
		cp "${SRC}/cache/sources/rtl88x2cs/${rtl88x2csver#*:}/Makefile" "$kerneldir/drivers/net/wireless/rtl88x2cs/Makefile"

		sed -i 's/---help---/help/g' "${SRC}/cache/sources/rtl88x2cs/${rtl88x2csver#*:}/Kconfig"
		cp "${SRC}/cache/sources/rtl88x2cs/${rtl88x2csver#*:}/Kconfig" "$kerneldir/drivers/net/wireless/rtl88x2cs/Kconfig"

		sed -i 's/include $(src)\/rtl8822c.mk/include $(TopDIR)\/drivers\/net\/wireless\/rtl88x2cs\/rtl8822c.mk/' "$kerneldir/drivers/net/wireless/rtl88x2cs/Makefile"
		sed -i "s/^CONFIG_RTW_DEBUG.*/CONFIG_RTW_DEBUG = n/" "$kerneldir/drivers/net/wireless/rtl88x2cs/Makefile"

		 echo "obj-\$(CONFIG_RTL8822CS) += rtl88x2cs/" >> "$kerneldir/drivers/net/wireless/Makefile"
		 sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/rtl88x2cs\/Kconfig"' "$kerneldir/drivers/net/wireless/Kconfig"
	fi
	...
	if linux-version compare "${version}" ge 5.0 && [ "$EXTRAWIFI" == yes ]; then
		...
		cp -R "${SRC}/cache/sources/rtl8723ds/${rtl8723dsver#*:}"/{core,hal,include,os_dep,platform} "$kerneldir/drivers/net/wireless/rtl8723ds"
		cp "${SRC}/cache/sources/rtl8723ds/${rtl8723dsver#*:}/Makefile" "$kerneldir/drivers/net/wireless/rtl8723ds/Makefile"

		sed -i 's/---help---/help/g' "${SRC}/cache/sources/rtl8723ds/${rtl8723dsver#*:}/Kconfig"
		cp "${SRC}/cache/sources/rtl8723ds/${rtl8723dsver#*:}/Kconfig" "$kerneldir/drivers/net/wireless/rtl8723ds/Kconfig"

		sed -i "s/^CONFIG_RTW_DEBUG.*/CONFIG_RTW_DEBUG = n/" "$kerneldir/drivers/net/wireless/rtl8723ds/Makefile"

		echo "obj-\$(CONFIG_RTL8723DS) += rtl8723ds/" >> "$kerneldir/drivers/net/wireless/Makefile"
		sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/rtl8723ds\/Kconfig"' "$kerneldir/drivers/net/wireless/Kconfig"
	fi
	...
	if linux-version compare $version ge 5.0 && [ "$EXTRAWIFI" == yes ]; then
		...
		cp -R ${SRC}/cache/sources/rtl8723du/${rtl8723duver#*:}/{core,hal,include,os_dep,platform} $kerneldir/drivers/net/wireless/rtl8723du
		cp ${SRC}/cache/sources/rtl8723du/${rtl8723duver#*:}/Makefile $kerneldir/drivers/net/wireless/rtl8723du/Makefile

		sed -i "s/^CONFIG_RTW_DEBUG.*/CONFIG_RTW_DEBUG = n/" $kerneldir/drivers/net/wireless/rtl8723du/Makefile

		echo "obj-\$(CONFIG_RTL8723DU) += rtl8723du/" >> $kerneldir/drivers/net/wireless/Makefile
		sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/rtl8723du\/Kconfig"' $kerneldir/drivers/net/wireless/Kconfig
	...
	if linux-version compare "${version}" ge 4.4 && [ "$EXTRAWIFI" == yes ]; then
		...
		cp -R "${SRC}/cache/sources/rtl8822bs/${rtl8822bsver#*:}"/{core,hal,include,os_dep,platform,bluetooth,getAP,rtl8822b.mk} $kerneldir/drivers/net/wireless/rtl8822bs
		cp "${SRC}/cache/sources/rtl8822bs/${rtl8822bsver#*:}/Makefile" $kerneldir/drivers/net/wireless/rtl8822bs/Makefile

		sed -i 's/---help---/help/g' "${SRC}/cache/sources/rtl8822bs/${rtl8822bsver#*:}/Kconfig"
		cp "${SRC}/cache/sources/rtl8822bs/${rtl8822bsver#*:}/Kconfig" "$kerneldir/drivers/net/wireless/rtl8822bs/Kconfig"

		echo "obj-\$(CONFIG_RTL8822BS) += rtl8822bs/" >> $kerneldir/drivers/net/wireless/Makefile
		sed -i '/source "drivers\/net\/wireless\/ti\/Kconfig"/a source "drivers\/net\/wireless\/rtl8822bs\/Kconfig"' $kerneldir/drivers/net/wireless/Kconfig
	fi
